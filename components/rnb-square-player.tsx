...
import type { RnBSquareTrack } from "@/lib/rnb-square-tracks"
import Image from "next/image"

interface RnBSquarePlayerProps {
  tracks: RnBSquareTrack[]
...
export default function RnBSquarePlayer({ tracks, onDownloadClick }: RnBSquarePlayerProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 backdrop-blur-sm border border-purple-500/20 rounded-xl p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="font-cinzel text-xl font-bold text-purple-400 mb-1">R&B SQUARE</h3>
      ...
      <div className="flex items-center justify-center space-x-1 mb-4">
        <Button
          ...
          className={`text-gray-400 hover:text-white ${shuffle ? "text-purple-400" : ""}`}
          title="Shuffle"
        >
        ...
        <Button
          ...
          className="text-white hover:text-purple-400 mx-2"
          disabled={isLoading}
        >
          {isLoading ? (
        ...
        <Button
          ...
          className={`text-gray-400 hover:text-white ${repeat !== "none" ? "text-purple-400" : ""}`}
          title={`Repeat: ${repeat}`}
        >
